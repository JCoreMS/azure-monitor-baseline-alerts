...
resource runbookGetStorage 'Microsoft.Automation/automationAccounts/runbooks@2023-11-01' = {
...
resource scheduleGetStorage 'Microsoft.Automation/automationAccounts/schedules@2023-11-01' = [for i in range(0, length(varTimeIncrement)) : {
  name: '${varScheduleName}Storage-${i}'
  parent: automationAccountExisting
  properties: {
...
resource jobGetStorage 'Microsoft.Automation/automationAccounts/jobSchedules@2023-11-01' = [for i in range(0, length(varTimeIncrement)) :{
  name: guid('${varScheduleName}Storage-${i}')
  parent: automationAccountExisting
  properties: {
    runbook: {
      name: RunbookNameGetStorage
